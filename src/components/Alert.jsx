...
const Alert = ({ type, message }) => {
  if (type === "success") {
    return (
      ...
      >
        <FaCheck className="text-2xl texg-emerald-700" />
        <p className="text-2xl texg-emerald-700">{message}</p>
      </motion.div>
    );
  }
  ...
  if (type === "warning") {
    return (
      ...
      >
        <BsExclamationTriangleFill className="text-2xl text-orange-700" />
  ...
  if (type === "danger") {
    return (
      ...
      >
        <BsExclamationTriangle className="text-2xl text-red-700" />
  ...
  if (type === "info") {
    return (
      ...
      >
        <BsExclamationTriangle className="text-2xl text-blue-700" />
        <p className="text-2xl text-blue-700">{message}</p>
      </motion.div>
    );
  }
};
